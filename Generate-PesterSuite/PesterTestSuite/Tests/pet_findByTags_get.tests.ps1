...
<#
.SYNOPSIS
    Pester tests for the GET /pet/findByTags endpoint.
...
Describe "GET /pet/findByTags Endpoint Tests" -Tags 'GET', 'pet' { # GET, /pet/findByTags, 'GET', 'pet' are expanded by the *generator*

    Context "Basic GET Request" { # GET expanded by the *generator*

        It "Should return a successful status code (2xx)" {
            # TODO: Handle path parameters (e.g., replace {id} with a valid value) if '/pet/findByTags' contains them.
            $requestPath = '/pet/findByTags' # Use backtick for literal . /pet/findByTags is expanded by the generator.
            ...
            #     Write-Warning "Test for path '/pet/findByTags' requires parameter '{$$paramName}'. Using placeholder '1'." # Escape $ for literal  output
