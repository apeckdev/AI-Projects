...
<#
.SYNOPSIS
    Pester tests for the PUT /pet endpoint.
...
Describe "PUT /pet Endpoint Tests" -Tags 'PUT', 'pet' { # PUT, /pet, 'PUT', 'pet' are expanded by the *generator*

    Context "Basic PUT Request" { # PUT expanded by the *generator*

        It "Should return a successful status code (2xx)" {
            # TODO: Handle path parameters (e.g., replace {id} with a valid value) if '/pet' contains them.
            $requestPath = '/pet' # Use backtick for literal . /pet is expanded by the generator.
            ...
            #     Write-Warning "Test for path '/pet' requires parameter '{$$paramName}'. Using placeholder '1'." # Escape $ for literal  output
