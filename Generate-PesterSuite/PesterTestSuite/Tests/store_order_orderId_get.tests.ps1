...
<#
.SYNOPSIS
    Pester tests for the GET /store/order/{orderId} endpoint.
...
Describe "GET /store/order/{orderId} Endpoint Tests" -Tags 'GET', 'store' { # GET, /store/order/{orderId}, 'GET', 'store' are expanded by the *generator*

    Context "Basic GET Request" { # GET expanded by the *generator*
        ...
        It "Should return a successful status code (2xx)" {
            ...
            Write-Verbose "Sending GET request to $uri" # GET expanded by generator
            ...
            try {
                ...
                # Use backticks for literal , , . 'GET' is literal string here.  needs backtick if used.
                $response = Invoke-WebRequest -Uri $uri -Method 'GET' -Headers $headers -ErrorAction Stop # Add -Body $body if needed
