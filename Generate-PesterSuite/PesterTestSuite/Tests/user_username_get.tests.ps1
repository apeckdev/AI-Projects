...
<#
.SYNOPSIS
    Pester tests for the GET /user/{username} endpoint.
...
Describe "GET /user/{username} Endpoint Tests" -Tags 'GET', 'user' { # GET, /user/{username}, 'GET', 'user' are expanded by the *generator*
