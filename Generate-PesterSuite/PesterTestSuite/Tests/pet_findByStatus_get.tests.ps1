...
<#
.SYNOPSIS
    Pester tests for the GET /pet/findByStatus endpoint.
...
Describe "GET /pet/findByStatus Endpoint Tests" -Tags 'GET', 'pet' { # GET, /pet/findByStatus, 'GET', 'pet' are expanded by the *generator*

    Context "Basic GET Request" { # GET expanded by the *generator*

        It "Should return a successful status code (2xx)" {
            # TODO: Handle path parameters (e.g., replace {id} with a valid value) if '/pet/findByStatus' contains them.
            $requestPath = '/pet/findByStatus' # Use backtick for literal . /pet/findByStatus is expanded by the generator.
            ...
            #     Write-Warning "Test for path '/pet/findByStatus' requires parameter '{$$paramName}'. Using placeholder '1'." # Escape $ for literal  output
