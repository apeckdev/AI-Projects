...
<#
.SYNOPSIS
    Pester tests for the POST /pet/{petId} endpoint.
...
Describe "POST /pet/{petId} Endpoint Tests" -Tags 'POST', 'pet' { # POST, /pet/{petId}, 'POST', 'pet' are expanded by the *generator*
